        ...
        <div class="banner-content-area">
            <div class="container">
                <div class="banner-text text-lg-left text-center">
                    <h1 class="title">{{ $category->name }} <br>
                        <span style="font-size: 17px;">{{ $subcategories->count() }} Sub-Categories ,</span>
                        <span style="font-size: 17px;">Templates</span>
                    </h1>
                    ...
                    <div class="theiaStickySidebar">
                        <div class="row">
                            @foreach ($subcategories as $subCategory)
                                @foreach ($subCategory->templates->where('status', 1) as $template)
                                    ...
                                    <div class="modal fade" id="exampleModalCenter{{ $template->id }}" role="dialog"
                                        aria-labelledby="exampleModalCenter{{ $template->id }}Title" aria-hidden="true" tabindex="-1"
                                        wire:ignore.self>
                    ...
                    <div class="theiaStickySidebar">
                        <div class="widget">
                            <form class="search-form" action="#">
                                <input name="search" type="search" placeholder="Search Not Enabled">
                                    ...
                                    @foreach ($subcategories as $subCategory)
                                        <li>
                                            <a href="{{ route('template.by.subcategory', ['subcategory_slug' => $subCategory->slug]) }}">
                                                {{ $subCategory->name }} <span class="text-info">({{ $subCategory->templates->count() }})</span>
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
