        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="theiaStickySidebar">
                        <div class="row">
                            @foreach ($templates as $template)
                                ...
                                @push('script')
                                    <script>
                                        $('#exampleModalCenter{{ $template->id }}').appendTo("body");
                                    </script>
                                @endpush
                ...
                <div class="col-lg-4 pl-lg-5 sidebar">
                    <div class="theiaStickySidebar">
                        <div class="widget">
                            <form class="search-form" action="#" wire:submit.prevent>
                                <input name="search" type="search" placeholder="Search Templates Here" wire:model.lazy="search">
                                <button class="submit" type="button" wire:change="updateSearch($event.target.value)"><i
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-wrapper">
                                <ul>
                                    @foreach ($tags as $tag)
                                        <a href="{{ route('template.by.tag', ['tag_slug' => $tag->slug]) }}">
                                            <span
                                                class="text-capitalize {{ $tag->slug == $tagslug ? 'text-info font-weight-bold' : '' }}">{{ $tag->name }},
                                            </span>
                                        </a>
                                    @endforeach
                                </ul>
